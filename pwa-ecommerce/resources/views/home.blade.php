...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" nonce="0661861c857d4064b1653c9e758" src="https://local.adguard.org/?ts=1769695890024&type=content-script&dmn=yui.xioyuna.com&url=https%3A%2F%2Fyui.xioyuna.com%2Ftemplate%2F&app=com.google.Chrome&css=3&js=1&rel=1&rji=1&sbe=1"></script>
<script type="text/javascript" nonce="0661861c857d4064b1653c9e758" src="https://local.adguard.org/?ts=1769695890024&name=AdGuard%20Extra&type=user-script"></script><link rel="stylesheet" href="https://yui.xioyuna.com/template/css/framework7-bundle.css">
    <link rel="stylesheet" href="https://yui.xioyuna.com/template/css/framework7-icons.css">
    <link rel="stylesheet" href="https://yui.xioyuna.com/template/css/style.css?v=10">
  </head>
  <body class="color-blue">
    ...
    <div id="app">
      ...
      <div class="panel panel-left panel-push panel-init">
        <div class="profile-header">
          ...
          <div class="profile-subtitle"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bbd5d8dad6d9cbded7d7fbded5cddacfd495d8d4d6">[email&#160;protected]</a></div>
        </div>
              ...
              <div class="navbar-inner">
                <div class="left">
                  <a href="/settings/" class="link icon-only navbar-profile">
                    <img src="https://yui.xioyuna.com/template/img/avatars/small-avatar.jpg" alt="">
                  </a>
                </div>
            ...
            <div class="page-content">
              <swiper-container class="full-width" slides-per-view="2.4" space-between="15" slides-offset-after="15"
                ...
                <swiper-slide>
                  <a href="#" data-href="/movie/" class="card card-movie">
                    <div class="card-image">
                      <img src="https://yui.xioyuna.com/template/img/movies/1.jpg" alt="">
                ...
                <swiper-slide>
                  <a href="#" data-href="/movie/" class="card card-movie">
                    <div class="card-image">
                      <img src="https://yui.xioyuna.com/template/img/movies/2.jpg" alt="">
                      <div class="card-movie-rating">
                        <i class="icon f7-icons text-color-yellow">star_fill</i>
                        4.3/5
                      </div>
                ...
                <swiper-slide>
                  <a href="#" data-href="/movie/" class="card card-movie">
                    <div class="card-image">
                      <img src="https://yui.xioyuna.com/template/img/movies/3.jpg" alt="">
                      <div class="card-movie-rating">
                        <i class="icon f7-icons text-color-yellow">star_fill</i>
                        4.1/5
                      </div>
                ...
                <swiper-slide>
                  <a href="#" data-href="/movie/" class="card card-movie">
                    <div class="card-image">
                      <img src="https://yui.xioyuna.com/template/img/movies/4.jpg" alt="">
                      <div class="card-movie-rating">
                        <i class="icon f7-icons text-color-yellow">star_fill</i>
                        4.5/5
                      </div>
              ...
              <div class="grid grid-cols-2 album-grid">
                <a href="/album/" class="link">
                  <img src="https://yui.xioyuna.com/template/img/albums/1.jpg" alt="">
                ...
                <a href="/album/" class="link">
                  <img src="https://yui.xioyuna.com/template/img/albums/2.jpg" alt="">
                  <div class="album-details">
                ...
                <a href="/album/" class="link">
                  <img src="https://yui.xioyuna.com/template/img/albums/3.jpg" alt="">
                  <div class="album-details">
                ...
                <a href="/album/" class="link">
                  <img src="https://yui.xioyuna.com/template/img/albums/4.jpg" alt="">
                  <div class="album-details">
                ...
                <a href="/album/" class="link">
                  <img src="https://yui.xioyuna.com/template/img/albums/5.jpg" alt="">
                  <div class="album-details">
                ...
                <a href="/album/" class="link">
                  <img src="https://yui.xioyuna.com/template/img/albums/6.jpg" alt="">
                  <div class="album-details">
                ...
                <ul>
                  <li>
                    <a href="#" class="item-link item-content">
                      <div class="item-media"><img src="https://yui.xioyuna.com/template/img/events/1.jpg" class="event-thumbnail" alt=""></div>
                  ...
                  <li>
                    <a href="#" class="item-link item-content">
                      <div class="item-media"><img src="https://yui.xioyuna.com/template/img/events/2.jpg" class="event-thumbnail" alt=""></div>
                      <div class="item-inner">
                        <div class="item-title">
                  ...
                  <li>
                    <a href="#" class="item-link item-content">
                      <div class="item-media"><img src="https://yui.xioyuna.com/template/img/events/3.jpg" class="event-thumbnail" alt=""></div>
                      <div class="item-inner">
                        <div class="item-title">
                  ...
                  <li>
                    <a href="#" class="item-link item-content">
                      <div class="item-media"><img src="https://yui.xioyuna.com/template/img/events/4.jpg" class="event-thumbnail" alt=""></div>
                      <div class="item-inner">
                        <div class="item-title">
                  ...
                  <li>
                    <a href="#" class="item-link item-content">
                      <div class="item-media"><img src="https://yui.xioyuna.com/template/img/events/5.jpg" class="event-thumbnail" alt=""></div>
                      <div class="item-inner">
                        <div class="item-title">
              ...
              <swiper-container class="full-width" slides-per-view="2.4" space-between="15" slides-offset-after="15"
                ...
                <swiper-slide>
                  <a href="#" data-href="/album/" class="card card-album">
                    <div class="card-image">
                      <img src="https://yui.xioyuna.com/template/img/albums/7.jpg" alt="">
                      <div class="card-movie-rating">
                        <i class="icon f7-icons text-color-yellow">star_fill</i>
                        4.8/5
                      </div>
                ...
                <swiper-slide>
                  <a href="#" data-href="/album/" class="card card-album">
                    <div class="card-image">
                      <img src="https://yui.xioyuna.com/template/img/albums/8.jpg" alt="">
                      <div class="card-movie-rating">
                        <i class="icon f7-icons text-color-yellow">star_fill</i>
                        4.3/5
                      </div>
                ...
                <swiper-slide>
                  <a href="#" data-href="/album/" class="card card-album">
                    <div class="card-image">
                      <img src="https://yui.xioyuna.com/template/img/albums/9.jpg" alt="">
                      <div class="card-movie-rating">
                        <i class="icon f7-icons text-color-yellow">star_fill</i>
                        4.1/5
                      </div>
                ...
                <swiper-slide>
                  <a href="#" data-href="/album/" class="card card-album">
                    <div class="card-image">
                      <img src="https://yui.xioyuna.com/template/img/albums/10.jpg" alt="">
                      <div class="card-movie-rating">
                        <i class="icon f7-icons text-color-yellow">star_fill</i>
                        4.5/5
                      </div>
              ...
              <div class="post-list">
                <a href="/single/" class="link post-horizontal">
                  ...
                  <div class="post-image"><img src="https://yui.xioyuna.com/template/img/post-list/11.jpg" alt=""></div>
                </a>
                <a href="/single/" class="link post-horizontal">
                  <div class="infos">
                  ...
                  <div class="post-image"><img src="https://yui.xioyuna.com/template/img/post-list/12.jpg" alt=""></div>
                </a>
                <a href="/single/" class="link post-horizontal">
                  <div class="infos">
                    <div class="post-category">Music</div>
                  ...
                  <div class="post-image"><img src="https://yui.xioyuna.com/template/img/post-list/13.jpg" alt=""></div>
                </a>
              </div>
            </div>
          </div>
            ...
            <div class="page-content">
              <swiper-container class="full-width" slides-per-view="1.2" space-between="15" slides-offset-after="15"
                ...
                <swiper-slide>
                  <a href="#" data-href="/single/" class="card">
                    <div class="card-image">
                      <img src="https://yui.xioyuna.com/template/img/cards/1.jpg" alt="">
                ...
                <swiper-slide>
                  <a href="#" data-href="/single/" class="card">
                    <div class="card-image">
                      <img src="https://yui.xioyuna.com/template/img/cards/2.jpg" alt="">
                      <div class="card-image-footer">
                ...
                <swiper-slide>
                  <a href="#" data-href="/single/" class="card">
                    <div class="card-image">
                      <img src="https://yui.xioyuna.com/template/img/cards/3.jpg" alt="">
                      <div class="card-image-footer">
              ...
              <div class="post-list">
                <a href="/single/" class="link post-horizontal">
                  ...
                  <div class="post-image"><img src="https://yui.xioyuna.com/template/img/post-list/2.jpg" alt=""></div>
                </a>
                <a href="/single/" class="link post-horizontal">
                  <div class="infos">
                  ...
                  <div class="post-image"><img src="https://yui.xioyuna.com/template/img/post-list/7.jpg" alt=""></div>
                </a>
                <a href="/single/" class="link post-horizontal">
                  <div class="infos">
                  ...
                  <div class="post-image"><img src="https://yui.xioyuna.com/template/img/post-list/8.jpg" alt=""></div>
                </a>
              </div>
              <div class="section-title">
                Popular Authors
                ...
                <ul>
                  <li>
                    <div class="item-content">
                      <div class="item-media"><img src="https://yui.xioyuna.com/template/img/avatars/11.jpg" alt=""></div>
                      <div class="item-inner">
                        <div class="item-title">
                  ...
                  <li>
                    <div class="item-content">
                      <div class="item-media"><img src="https://yui.xioyuna.com/template/img/avatars/3.jpg" alt=""></div>
                      <div class="item-inner">
                        <div class="item-title">
                  ...
                  <li>
                    <div class="item-content">
                      <div class="item-media"><img src="https://yui.xioyuna.com/template/img/avatars/4.jpg" alt=""></div>
                      <div class="item-inner">
                        <div class="item-title">
              ...
              <div class="post-list">
                <a href="/single/" class="link post-horizontal">
                  ...
                  <div class="post-image"><img src="https://yui.xioyuna.com/template/img/post-list/6.jpg" alt=""></div>
                </a>
                <a href="/single/" class="link post-horizontal">
                  <div class="infos">
                  ...
                  <div class="post-image"><img src="https://yui.xioyuna.com/template/img/post-list/5.jpg" alt=""></div>
                </a>
                <a href="/single/" class="link post-horizontal">
                  <div class="infos">
                    <div class="post-category">Music</div>
                  ...
                  <div class="post-image"><img src="https://yui.xioyuna.com/template/img/post-list/10.jpg" alt=""></div>
                </a>
              </div>
              ...
              <div class="grid grid-cols-2 grid-gap">
                <a href="/post-list/" class="category-item link">
                  <img src="https://yui.xioyuna.com/template/img/categories/9.jpg" alt="">
                  <div class="category-name">Travel</div>
                </a>
                <a href="/post-list/" class="category-item link">
                  <img src="https://yui.xioyuna.com/template/img/categories/10.jpg" alt="">
                  <div class="category-name">Health</div>
                </a>
                <a href="/post-list/" class="category-item link">
                  <img src="https://yui.xioyuna.com/template/img/categories/11.jpg" alt="">
                  <div class="category-name">Food</div>
                </a>
                <a href="/post-list/" class="category-item link">
                  <img src="https://yui.xioyuna.com/template/img/categories/12.jpg" alt="">
                  <div class="category-name">Environment</div>
                </a>
                <a href="/post-list/" class="category-item link">
                  <img src="https://yui.xioyuna.com/template/img/categories/7.jpg" alt="">
                  <div class="category-name">Art</div>
                </a>
                <a href="/post-list/" class="category-item link">
                  <img src="https://yui.xioyuna.com/template/img/categories/5.jpg" alt="">
    ...
    <script data-cfasync="false" src="https://yui.xioyuna.com/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="https://yui.xioyuna.com/template/js/framework7-bundle.min.js"></script>
    <script src="https://yui.xioyuna.com/template/js/app.js?v=10"></script>
