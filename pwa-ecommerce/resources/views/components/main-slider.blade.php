        ...
        <div class="pt-3">
            ...
            <div class="hero-slides owl-carousel">
                @forelse($slides as $slide)
                    <!-- Single Hero Slide -->
                    <div class="single-hero-slide" style="background-image: url('{{ $slide['image'] ?? asset('frontend/img/bg-img/1.jpg') }}')">
                        <div class="slide-content h-100 d-flex align-items-center">
                            <div class="slide-text">
                                ...
                                <a class="btn btn-primary" href="{{ $slide['link'] ?? '#' }}" data-animation="fadeInUp" data-delay="800ms" data-duration="1000ms">
                                    Buy Now
                                </a>
                            </div>
                        </div>
                ...
                @empty
                    <!-- Default Single Hero Slide -->
                    <div class="single-hero-slide" style="background-image: url('{{ asset('frontend/img/bg-img/1.jpg') }}')">
                        <div class="slide-content h-100 d-flex align-items-center">
                            <div class="slide-text">
                    ...
                    <!-- Single Hero Slide -->
                    <div class="single-hero-slide" style="background-image: url('{{ asset('frontend/img/bg-img/2.jpg') }}')">
                        <div class="slide-content h-100 d-flex align-items-center">
                            <div class="slide-text">
                    ...
                    <!-- Single Hero Slide -->
                    <div class="single-hero-slide" style="background-image: url('{{ asset('frontend/img/bg-img/3.jpg') }}')">
                        <div class="slide-content h-100 d-flex align-items-center">
                            <div class="slide-text">
